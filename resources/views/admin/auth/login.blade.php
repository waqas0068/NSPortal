...
<div id="app">
    ...
    <section class="section">
        <div class="d-flex flex-wrap align-items-stretch justify-center justify-content-center">
            <div class="col-lg-6 col-md-8 col-12 order-lg-1 order-2 bg-white">
                <div class="p-4 m-3">
                    <img src="{{ $siteGeneralSettings['logo'] ?? '' }}" alt="logo" width="40%" style="" class="mb-5 mt-2">
